...
interface MetasEmpresaHeaderProps {
  empresaId: string | null;
}

export function MetasEmpresaHeader({ empresaId }: MetasEmpresaHeaderProps) {
  const { user } = useAuth();
    ...
    <Card>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Gestão de metas da empresa</p>
            </div>
          </div>
      ...
      <CardContent>
        ...
        <div className="text-xs text-muted-foreground">
          Defina e acompanhe suas metas para indicadores do plano de contas e indicadores personalizados
        </div>
      </CardContent>
    </Card>
  );
